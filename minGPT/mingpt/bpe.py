...
def get_encoder():
    ...
    """
    home_dir = '/home/princeton/Downloads/Project/minGPT/mingpt/'
...
if __name__ == '__main__':
    ...
    text = "Hello this is your last day to live. w00t :D 🤗"
    e = get_encoder()
    ...
    print(r['tokens'])
    # ['Hello', ' this', ' is', ' your', ' last', ' day', ' to', ' live', '.', ' w', '00', 't', ' :', 'D', ' 🤗']
    ...
    # {'token': ' this', 'token_bytes': b' this', 'token_translated': 'Ġthis', 'token_merged': ['Ġthis'], 'token_ix': [428]}
    # {'token': ' is', 'token_bytes': b' is', 'token_translated': 'Ġis', 'token_merged': ['Ġis'], 'token_ix': [318]}
    # {'token': ' your', 'token_bytes': b' your', 'token_translated': 'Ġyour', 'token_merged': ['Ġyour'], 'token_ix': [534]}
    # {'token': ' last', 'token_bytes': b' last', 'token_translated': 'Ġlast', 'token_merged': ['Ġlast'], 'token_ix': [938]}
    # {'token': ' day', 'token_bytes': b' day', 'token_translated': 'Ġday', 'token_merged': ['Ġday'], 'token_ix': [1110]}
    # {'token': ' to', 'token_bytes': b' to', 'token_translated': 'Ġto', 'token_merged': ['Ġto'], 'token_ix': [284]}
    # {'token': ' live', 'token_bytes': b' live', 'token_translated': 'Ġlive', 'token_merged': ['Ġlive'], 'token_ix': [2107]}
    ...
    print(r['bpe_idx'])
    # [15496, 428, 318, 534, 938, 1110, 284, 2107, 13, 266, 405, 83, 1058, 35, 12520, 97, 245]
